...
1. Branch a new branch off `master` (see the [Using Git](/books/android/using-git) chapter for details).
...
12. Create README.md (see the [Readme](/books/android/project-readme) chapter for details). 
